...
*/
        ...
        webview.executeJavaScript("+(require('electron-notification-shim')());");
...
//         }
//         alert('here');
//         webview.instance.executeJavaScript("+(require('electron-notification-shim')());alert('here');", false, function(data){ Log.info(data); });
//         _updateCanGoBack();
//         _requestUpdateWebViewPid();
